...
export const homeData = {
    ...
    selectedWork: [
        ...
        },
        {
            id: "gridaware",
            name: "GridAware",
            oneLiner: "Smart EV charging optimizer using live EPEX Spot market prices.",
            problem: "EV owners have no simple way to find the cheapest charging window from volatile hourly prices.",
            approach: "Built a React + FastAPI application with a Pandas-based rolling-window optimization algorithm and interactive Recharts visualizations.",
            output: "Web dashboard: price overlay, optimal window recommendation, fractional-hour precision with AC/DC efficiency modeling.",
