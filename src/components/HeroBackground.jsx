      ...
      >
        <defs>
          <pattern id="dotPattern" x="0" y="0" width="40" height="40" patternUnits="userSpaceOnUse">
            <circle cx="2" cy="2" r="1.5" fill="rgba(198, 255, 0, 0.15)" />
          </pattern>
        </defs>
        ...
        <g transform="translate(1600, 850)" opacity="0.4">
          ...
          {/* A few faint glowing windows */}
          <circle cx="-20" cy="-150" r="1.5" className={styles.towerNode} opacity="0.3" />
          <circle cx="200" cy="-200" r="1.5" className={styles.towerNode} opacity="0.3" />
          <circle cx="320" cy="-280" r="1.5" className={styles.towerNode} opacity="0.3" />
        </g>
        ...
        <g transform="translate(2000, 850) scale(1.8)">
          ...
          <path d="M -8 0 L -2 -350 L 2 -350 L 8 0 Z" className={styles.utilityFill} />
          <circle cx="0" cy="-350" r="8" className={styles.utilityFill} />
          <g className={styles.spinBlades} style={{ transformOrigin: '0px -350px', animationDuration: '40s' }}>
            <path d="M 0 -350 L -8 -500 L 0 -510 L 8 -500 Z" className={styles.utilityFill} />
            <path d="M 0 -350 L 130 -275 L 140 -285 L 125 -295 Z" className={styles.utilityFill} />
            <path d="M 0 -350 L -130 -275 L -140 -285 L -125 -295 Z" className={styles.utilityFill} />
            <circle cx="0" cy="-350" r="4" className={styles.utilityFill} />
          </g>
        </g>
        ...
        <g transform="translate(1600, 850) scale(1.4)">
          ...
          <g transform="translate(0, -20) skewX(-30)">
            <path d="M -70 -40 L 70 -40 L 80 40 L -60 40 Z" className={styles.utilityFill} />
            {/* Grid lines */}
            <path d="M -65 -20 L 75 -20" className={styles.utilityLine} />
            <path d="M -60 0 L 80 0" className={styles.utilityLine} />
            <path d="M -55 20 L 85 20" className={styles.utilityLine} />
            
            <path d="M -30 -40 L -20 40" className={styles.utilityLine} />
            <path d="M 0 -40 L 10 40" className={styles.utilityLine} />
            <path d="M 30 -40 L 40 40" className={styles.utilityLine} />
          </g>
        ...
        {/* Battery Storage - With Lightning Bolt */}
        <g transform="translate(1820, 850) scale(1.2)">
          <path d="M -40 0 L 40 0" className={styles.utilityLine} />
          <rect x="-30" y="-80" width="60" height="80" rx="4" className={styles.utilityFill} />
          <rect x="-15" y="-90" width="30" height="10" rx="2" className={styles.utilityFill} />
          {/* Lightning Bolt */}
          <path d="M 5 -65 L -12 -35 L 2 -35 L -5 -10 L 15 -45 L -2 -45 Z" className={styles.utilityLine} />
